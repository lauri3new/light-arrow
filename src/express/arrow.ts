...
import { Context, notFound, Result, runResponse } from './result'

export type httpRoutes<Ctx extends object = object, A extends Context = Context> = (ctx: A) => Arrow<Ctx, notFound | Result, Result> | Arrow<Ctx, notFound, Result>
